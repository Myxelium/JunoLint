...
module.exports = {
  ...
  rules: {
    ...
    'component-own-folder': require('./rules/component-own-folder'),
    'component-max-external-types': require('./rules/component-max-external-types'),
    'explicit-function-return-type': require('./rules/explicit-function-return-type'),
